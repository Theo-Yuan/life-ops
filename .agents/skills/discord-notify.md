...
- `projects/workout/.agents/profile.md` → 偏好、限制、当前阶段（减载周等）
...
**动作填充规则**：
- 根据分化类型（推/拉/腿）从 `docs/workout/knowledge/计划设计.md` 的 PPL 模板选取
- 结合 `projects/workout/.agents/profile.md` 中的偏好和限制（如腿部打磨期不做杠铃深蹲）
